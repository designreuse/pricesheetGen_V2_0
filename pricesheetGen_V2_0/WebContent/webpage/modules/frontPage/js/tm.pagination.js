...
//	显示第1到第2条记录，总共2条记录，每页显示 10   条记录
    return {
        ...
        template: '<div class="page-list">' +
            ...
            '每页显示<select ng-model="conf.itemsPerPage" ng-options="option for option in conf.perPageOptions " ng-change="changeItemsPerPage()"></select>条记录,' +
            ',总共<strong>{{ conf.totalItems }}</strong>条记录.' +
            '</div>' +
