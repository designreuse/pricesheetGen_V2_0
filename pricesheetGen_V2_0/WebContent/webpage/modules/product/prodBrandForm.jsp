...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="prodBrand" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         <td class="active" width="15%"><label class="pull-right"><font color="red">*</font>商品品牌编号:</label></td>
		         <td ><form:input path="brandId" readonly="true" htmlEscape="false" maxlength="50" class="form-control required" /></td>
		      </tr>
		      <tr>
		         <td class="active" width="15%"><label class="pull-right"><font color="red">*</font>商品品牌名称:</label></td>
		         <td ><form:input path="brandName" readonly="true"  htmlEscape="false" maxlength="50" class="form-control required "/></td>
		      </tr>
		       <tr>
		       ...
		       <tr>
		         ...
		         <td ><fmt:formatDate value="${prodBrand.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
		      </tr>
		 </tbody>
		 </table>
	</form:form>
