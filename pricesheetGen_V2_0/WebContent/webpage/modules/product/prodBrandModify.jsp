...
<body class="hideScroll">
	<form method="post" id="inputForm" name="inputForm"  action="${ctx}/product/prodBrand/update">
		<input type="hidden" name="id" value="${prodBrand.uid}" />
		<sys:message content="${message}"/>
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         <td class="active" width="15%"><label class="pull-right"><font color="red">*</font>商品品牌编号:</label></td>
		         <td ><input name="brandId" readonly="readonly" value="${prodBrand.brandId}" maxlength="50" class="form-control required" /></td>
		      </tr>
		      <tr>
		         <td class="active" width="15%"><label class="pull-right"><font color="red">*</font>商品品牌名称:</label></td>
		         <td ><input name="brandName"   value="${prodBrand.brandName}" maxlength="50" class="form-control required "/></td>
		      </tr>
		 </tbody>
		 </table>
	</form>
