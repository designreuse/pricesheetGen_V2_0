...
<body class="hideScroll">
	...
	<form method="post" id="inputForm" name="inputForm"  action="${ctx}/product/prodBrand/pSave">
		<sys:message content="${message}"/>
		<input type="hidden" value="${addOrEdit}" name="addOrEdit"/>
		<input type="hidden" value="${pId}" name="pId"/>
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         <td class="active" width="40%"><label class="pull-right"><font color="red">*</font>商品品牌编号:</label></td>
		         <td  ><input type="text"  class="form-control" name="brandId" value="${brandId}" readonly="readonly" /></td>
		      </tr>
		       <tr>
		         <td class="active" width="40%"><label class="pull-right"><font color="red">*</font>商品品牌名称:</label></td>
		         <td  ><input type="text" class="form-control" name="brandName" value=""  /></td>
		      </tr>
<!-- 		      <tr> -->
