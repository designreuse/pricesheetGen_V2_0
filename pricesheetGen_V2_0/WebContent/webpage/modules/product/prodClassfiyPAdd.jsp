...
<body class="hideScroll">
	...
	<form method="post" id="inputForm" name="inputForm"  action="${ctx}/product/prodClassfiy/pSave">
		...
		<input type="hidden" value="${pId}" name="pId"/>
		 <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         <td class="active" width="40%"><label class="pull-right"><font color="red">*</font>商品类型编号:</label></td>
		         <td ><input type="text"  class="form-control" name="prodClassfiyId" value="${classfiyId}" readonly="readonly" /></td>
		      </tr>
		      <tr>
		         <td class="active" width="40%"><label class="pull-right"><font color="red">*</font>商品类型名称:</label></td>
