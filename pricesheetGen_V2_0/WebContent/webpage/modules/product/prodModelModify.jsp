...
<body class="hideScroll">
	<form method="post" id="inputForm" name="inputForm"  action="${ctx}/product/prodModel/update">
		<input type="hidden" name="id" value="${prodModel.uid}" /> 
		<sys:message content="${message}"/>
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         <td class="active" width="15%"><label class="pull-right"><font color="red">*</font>商品型号编号:</label></td>
		         <td ><input name="modelId" readonly="readonly" value="${prodModel.modelId}"  maxlength="50" class="form-control required" /></td>
		      </tr>
		      <tr>
		         <td class="active" width="15%"><label class="pull-right"><font color="red">*</font>商品型号名称:</label></td>
		         <td ><input name="modelName" value="${prodModel.modelName}"  maxlength="50" class="form-control required "/></td>
		      </tr>
		 </tbody>
		 </table>
	</form>
