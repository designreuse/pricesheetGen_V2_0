...
<body class="hideScroll">
	...
	<form method="post" id="inputForm" name="inputForm"  action="${ctx}/product/prodModel/pSave">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         <td class="active" width="40%"><label class="pull-right"><font color="red">*</font>商品型号编号:</label></td>
		         <td  ><input type="text"  class="form-control" name="modelId" value="${modelId}" readonly="readonly" /></td>
		      </tr>
		       <tr>
		         <td class="active" width="40%"><label class="pull-right"><font color="red">*</font>商品型号名称:</label></td>
