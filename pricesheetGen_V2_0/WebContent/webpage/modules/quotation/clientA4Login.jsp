        ...
        subfieldChsNameList, subfieldEngNameList)
{
    ...
    for (var i = 0; i <= curTypeTblLen; i++) 
    {
       ...
       /*  if (0 == i) 
        ...
        {
            tdCur.innerHTML = "<input type=text style=\"width:100%;border:0px;\" name=\"" + curTypeTbl[i-1] + "\" />";
        }
    }
...
<div class="col-sm-12">
	...
	<div style="width:850px;margin: 0px auto ;" >
		  <div id="login-inbox" hidden="false">
		...
		<form name="myForm">
		    <div id="headDivId" >    
		        <table id="headTab" style="text-align:center;width:100%;"  >  
		           <tr>
		               ...
		               <td style="text-align:left;">
		               <!-- 	<div class="form-options">
		               		<!-- <a  id="login-inboxClick" href="#" > 登录/ </a>
		               		<a  data-target="#signup-box" href="#" >注册</a>/ 
		               		<a  data-target="#forgot-box" href="#" >忘记密码</a>/ -->
		               	</div> -->
		               </td>
		           </tr>	
		        </table>
		        ...
		        <div >
			        <div style="float: left;width: 45%;">
			        		<div style="margin-bottom:5px;height:25px;">
						        ...
						        <div   style="height:25px;text-align: left;float: left;width: 60%">
							...
							<div   style="margin-bottom:5px;height:25px;"> 
								...
								<div    style="height:25px;text-align: left;float: right;width: 60%">
						           <input type="text" id="company" name="company"   style="border: 0px;border-bottom: 1px solid;width: 95%;height:100%;color:black;text-align:center;" />
						        </div>
							</div>	
							<div   style="margin-bottom:5px;height:25px;">
								 <div style="text-align: right;line-height:25px;float: left;width: 40%">联系电话：</div>
								<div   style="height:25px;text-align: left;float: left;width: 60%">
						           <input type="text" id="companyPhone" name="companyPhone"   style="border: 0px;border-bottom: 1px solid;width: 95%;height:100%;color:black;text-align:center;" />
						        </div>
							</div>		
							<div  style="margin-bottom:5px;height:25px;">
								<div style="text-align: right;line-height:25px;float: left;width: 40%">联系传真：</div>
								<div    style="height:25px;text-align: left;float: left;width: 60%">
						          <input type="text" id="companyFax" name="companyFax"  style="border: 0px;border-bottom: 1px solid;width: 95%;height:100%;color:black;text-align:center;" />
						        </div>
							</div>		
							<div    style="margin-bottom:5px;height:25px;">
			        ...
			        <div  style="float: left;width: 55%" >
			        	<div style="text-align:right;margin-left:50px;">
			        		<div  style="margin-bottom:5px;height:25px;">
						        ...
						        <div   style="height:25px;text-align: left;float: left;width: 55%">
						        	<input id="quotationDateStr" name="quotationDateStr" type="text" readonly="readonly" maxlength="20" 
								class="input-medium Wdate"  style="border: 0px;border-bottom: 1px solid;width: 100%;height:100%;color:black;text-align:center;"
							...
							<div   style="margin-bottom:5px;height:25px;"> 
								...
								<div   style="height:25px;text-align: left;float: left;width: 55%">
									<input type="text" name="quotationCode" readonly="readonly"  style="border: 0px;border-bottom: 1px solid;width: 100%;height:100%;color:black;text-align:center;"  />
						        </div>
							</div>	
							<div   style="margin-bottom:5px;height:25px;">
								 <div style="text-align: right;line-height:25px;float: left;width: 45%">结算币种：</div>
								<div  style="height:25px;text-align: left;float: left;width: 55%">
									 <select id="settlementType" name="settlementType"  style="border: 0px;border-bottom: 1px solid;width: 100%;height:100%;color:black;">
							...
							<div  style="margin-bottom:5px;height:25px;">
								...
								<div    style="height:25px;text-align: left;float: left;width:55%">
									<select id="payType" name="payType" style="border: 0px;border-bottom: 1px solid;width: 100%;height:100%;color:black;" >
							...
							<div  style="margin-bottom:5px;height:25px;">
								...
								<div   style="height:25px;text-align: left;float: left;width: 55%">
									<select id="staffId" name="staffId"  style="border: 0px;border-bottom: 1px solid;width: 100%;height:100%;color:black;">
		    ...
		    <div id='mainDivId' >
		        ...
		        <table width="100%" id="tab" style="text-align:center;" border="1"  cellspacing="0" cellpadding="0"	>
		            <tr ><!-- <td width="10%">
		                <a id=mainAdd href="javascript:void(0)" onclick=
		                 ...
		                 <td width="50%">项目名称</td>
		                 <td style="text-align:center;width:10%;">计价币种</td>
		                 <td style="text-align:center;width:25%;">税后总额</td>
		             </tr>
		        </table>
		        <div id='area_sumAmount' style="width:100%;" >
		            <table width="100%"   style="text-align:center;"  cellspacing="0" cellpadding="0">  
						...
						<tr >						
						   <td style="text-align:right;border-left:1px solid black;height: 30px;">优惠(RMB):</td>
						...
						<tr >		                
							<td style="text-align:right;border-left:1px solid black;border-bottom :1px solid black;height: 30px;">最终价格(RMB):</td>
		    ...
		    <div id='subDivId'></div>
		    <div>
		    	<div  style="margin-top:20px;float: left;width:60%">
			...
			<div>
				...
				<div style="float: left;width:40%" >
					...
					<div style="font-weight: bold;font-size: 25px;height:80px;line-height:80px;">小强</div>
