...
<div class="col-sm-12">
	...
	<div class="col-sm-8">
	<%-- <div id="login-inbox2" hidden="false">
		    ...
		    <div id="headDivId">    
		        <table id="headTab" style="text-align:center;width:100%;"  >  
		           ...
		           <tr>
		               ...
		               <td style="text-align:left;"><input type="text" id="company" name="company" /></td>
		           ...
		           <tr>
		               ...
		               <td style="text-align:left;"><input type="text" id="companyPhone" name="companyPhone"  /></td>
		           ...
		           <tr>
		               ...
		               <td style="text-align:left;"><input type="text" id="companyFax" name="companyFax" /></td>
		           ...
		           <tr>
		               ...
		               <td style="text-align:left;"><input type=text name="quotationAbout" /></td>
		               <td style="text-align:right;">销售人员</td>
		               <td style="text-align:left;">
		                   <select id="staffId" name="staffId" style="width:170px;">
		                       <option value="a8196df87a9a40dfa4543b49d64c0759">sw</option>
		                   </select>
		                </td>
		               <td style="width:15%;"></td>                
		            </tr>
					     ...
					     <td style="text-align:left;width:60%;">			     
							<div id="tailDivId">
						        <table width="100%" id="tailTab" style="text-align:center;">
						            ...
						            <tr><td style="text-align:right;width:5%;">1、</td><td style="text-align:left;">报价均已含税（产品开具17%增值税发票，服务开具6%增值税发票）</td></tr>
				    ...
				    <tr>
					    <td>
					    	<table width="100%" style="text-align:center;">
					    		...
					    		<tr style="text-align:left;"><td>手机	13311763209</td><td>E-mail：gongquan.xie@sh-sapling.com</td></tr>
