	...
	<table id="contentTable" class="table table-striped table-bordered  table-hover table-condensed  dataTables-example dataTable no-footer">
		<thead>
			<tr>
				...
				<th width="18%" class="sort-column type">类型</th>
				<th width="20%"  class="sort-column description">描述</th>
				<th width="12%" class="sort-column value">键值</th>
				<th width="20%">标签</th>
				<th width="7%"  class="sort-column sort">排序</th>
				<th width="20%">操作</th>
			</tr>
		</thead>
		<tbody>
