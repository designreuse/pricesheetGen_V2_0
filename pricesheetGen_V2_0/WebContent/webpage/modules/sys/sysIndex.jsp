...
<head>
    ...
    <meta name="keywords" content="SapLing快速开发平台">
    <meta name="description" content="SapLing，采用spring mvc+mybatis+shiro+bootstrap，集成代码生成器的快速开发平台">
...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-left"><a href="http://www.sapling.org">http://www.sapling.org</a> &copy; 2015-2025</div>
            </div>
        </div>
        <!--右侧部分结束-->
