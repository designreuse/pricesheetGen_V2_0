...
<div id="login-box" class="login-box visible widget-box no-border bound">							
			 <%@ include file="/webpage/modules/quotation/clientIndex.jsp"%>   
</div><!-- /.login-box -->
										...
										<div class="widget-main bound">
											...
											<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/register/registerUser" method="post" class="form-group form-horizontal">
												...
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="userId" name="loginName" type="text" value="${user.loginName }" maxlength="20" minlength="3" class="form-control required" placeholder="您的账号名或您的登录名" />
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="userCnName" name="userCnName" type="text" maxlength="20" minlength="2" class="form-control required" placeholder="您的真实姓名" />
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="cpMail" name="cpMail" type="text" maxlength="20" minlength="3" class="form-control required" placeholder="您的公司邮箱用于收报价单" />
															<i class="ace-icon fa fa-envelope"></i>
														</span>
													</label>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="cpFax" name="cpFax" type="text" maxlength="20" minlength="3" class="form-control required" placeholder="您的公司邮传真" />
