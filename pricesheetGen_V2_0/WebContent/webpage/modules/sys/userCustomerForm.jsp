...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/saveCustomer" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         ...
		         <td class="width-35">
		         	<input type="hidden" id="isCustomer" name="isCustomer" value="1" class="form-control" />
		      ...
		      <tr>
 				...
 				title="部门" url="/sys/office/treeData?type=2" cssClass="form-control" notAllowSelectRoot="true" /> 
