...
<head>
	...
	<script type="text/javascript">
		function refresh(){//刷新
			...
			window.location="${ctx}/sys/user/customerIndex";
		}
	</script>
</head>
<body class="gray-bg">
	...
	<div id="content" class="row">
		...
		<div id="right"  class="col-sm-11  animated fadeInRight">
			<iframe id="officeContent" name="officeContent" src="${ctx}/sys/user/customerList" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	</div>
	</div>
	<script type="text/javascript">
		var setting = {
			...
			callback:{ 
				onClick:function(event, treeId, treeNode){
					...
					$('#officeContent').attr("src","${ctx}/sys/user/customerList?"+
		...
		function refreshTree(){
			...
			$.getJSON("${ctx}/sys/office/officeTreeData?isXSCompany=1",function(data){
