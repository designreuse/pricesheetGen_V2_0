...
import com.sapling.common.sms.SMSUtils;
import com.sapling.common.utils.CacheUtils;
import com.sapling.common.utils.SpringContextHolder;
...
//		getCacheMap().remove(key);
	 ...
	 * @return
	 */
	public static List<User> findUserRuleCodeOrId(String roleCode,String roleId){
		Role _rl = new Role();
		_rl.setRoleCode(roleCode);
		_rl.setId(roleId);
		User user = new User();
		user.setRole(_rl);
