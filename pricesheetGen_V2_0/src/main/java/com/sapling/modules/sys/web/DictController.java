/**
 * Copyright &copy; 2015-2020 <a href="http:///">JeePlus</a> All rights reserved.
 */
...
import com.sapling.modules.sys.service.DictService;
...
public class DictController extends BaseController {
	...
	public String list(Dict dict, HttpServletRequest request, HttpServletResponse response, Model model) {
		List<Dict> typeList = dictService.findTypeListObj();
